...
df = pd.read_csv(r'G:\My Drive\Birkbeck\Project\Hansard\hansard_speeches_2015-20_step4.csv', encoding='utf-8')
...
for speech in nlp.pipe(speeches, batch_size=200): #batched approach is quicker
    ...
    tokenised_speeches.append(' '.join(tokens)) #collect the tokens

df['tokens'] = tokenised_speeches #add to list
...
df.to_csv(r'G:\My Drive\Birkbeck\Project\Hansard\hansard_speeches_2015-20_step5.csv', index=False, encoding='utf-8')