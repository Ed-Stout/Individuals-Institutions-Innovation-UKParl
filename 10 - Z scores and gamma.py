...
for scale in scales: #catches the two scripts drifting apart if scales are changed in one and not the other
...
#=========gamma aka novelty, Barron equation 3============
gamma_results = []
...
for scale in scales:
    ...
    print("scale", scale, "| gamma", round(gamma, 4), " 99% CI", round(gamma_low, 4), "to", round(gamma_high, 4),"| R2", round(model.rsquared, 4))
